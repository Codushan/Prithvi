    ...
    <section className={styles.landingContainer} ref={containerRef}>
      ...
      <div className={styles.content}>
        ...
        {/* <div className={styles.otherS}>
          <Image src="/Sponsor1.png" height={50} width={100} alt='Skymart@titleSponsor'></Image>
          <Image src="/Sponsor2.png" height={50} width={200} alt='Skymart@titleSponsor'></Image>
          <Image src="/bankLogo.png" height={50} width={200} alt='Skymart@titleSponsor'></Image>
        </div> */}
